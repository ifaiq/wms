...
describe("Adding a New Saudi Vendor", () => {
  ...
  it("editSaudiVendor", () => {
    ...
    cy.get(fdata.vendor_Name_Locator)
      ...
      .clear()
      .type(
        "Saudi Vendor EditAuto Testing Co." +
          " " +
  ...
  it("validationOnEmptySaudiVendor", () => {
    ...
    cy.clickButton(fdata.click_Save_Vendor);
    cy.get(fdata.error_Empty_Vendor_Form_Locator)
      .contains("VAT is required!")
      .should("have.text", "VAT is required!");
  ...
  it("confirmSaudiVendorData", () => {
    ...
    cy.get(":nth-child(1) > :nth-child(5) > .flex > .mt-4")
      ...
      .then((value) => {
        cy.get("@userInfo").should((xhr) => {
          expect(xhr.response.body.country).to.eq("SAUDI");
        });
      });
    //  Compare Type
